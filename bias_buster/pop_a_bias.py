...
from .util import get_story, get_headline
...
def pop_bias(link):
    ...
    final_answer = {get_headline(val[1]): val[:2] + [news_name] for key, val in rv.items()}
